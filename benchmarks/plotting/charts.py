...
def plot_heatmap(
    ...
    """Heatmap grid (e.g., strategies x entry counts)."""
    import matplotlib.pyplot as plt
    import numpy as np
...
def plot_throughput_comparison(
    results: list[dict], title: str, system_info: str, output: Path
) -> Path:
    """Horizontal bar chart showing throughput (entries/sec)."""
    import matplotlib.pyplot as plt
    import numpy as np
    ...
    bars = ax.barh(
        ...
        height=0.6,
        color=colors_list,
        edgecolor=[c + "88" for c in colors_list],
        linewidth=1.5,
        zorder=3,
    )
