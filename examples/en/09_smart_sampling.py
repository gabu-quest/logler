...
sample = investigate.smart_sample(files=[log_file], strategy="representative", sample_size=10)
...
print("\n🌈 Strategy 2: Diverse sampling (maximum variety)")
sample = investigate.smart_sample(files=[log_file], strategy="diverse", sample_size=10)
...
print("\n⏰ Strategy 4: Chronological (evenly spaced over time)")
sample = investigate.smart_sample(files=[log_file], strategy="chronological", sample_size=10)
