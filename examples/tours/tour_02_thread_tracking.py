...
@app.cell
def _(follow_thread, format_duration, log_file):
...
@app.cell
def _(follow_thread, format_duration, log_file, service_label):
...
@app.cell
def _(failed_timeline, format_duration, request_timeline):
    ...
    print(f"{'Duration (ms)':<25} {format_duration(success):<20} {format_duration(failure):<20}")
...
@app.cell
def _(failed_timeline, request_timeline, service_label):
