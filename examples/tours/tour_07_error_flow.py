...
def _():
    ...
    logs.append(
        {
            ...
            "trace_id": "trace-error-001",
            "span_id": "products.fetch",
            "parent_span_id": "catalog.request",
            "operation_name": "Fetch Product Catalog",
    ...
    logs.append(
        {
            ...
            "trace_id": "trace-error-001",
            "span_id": "products.db",
            "parent_span_id": "products.fetch",
            "operation_name": "Products DB Query",
            "service": "postgres",
            "duration_ms": 3000,
    ...
    logs.append(
        {
            "timestamp": (base_time + timedelta(milliseconds=3100)).isoformat(),
            "level": "ERROR",
            "message": "Cache miss and DB unavailable",
            "trace_id": "trace-error-001",
            "span_id": "products.cache",
            "parent_span_id": "products.fetch",
            "operation_name": "Cache Fallback",
            "service": "redis",
            "duration_ms": 100,
            "error": "CacheMiss",
        }
    ...
    logs.append(
        {
            "timestamp": (base_time + timedelta(milliseconds=3200)).isoformat(),
            "level": "ERROR",
    ...
    logs.append(
        {
            ...
            "span_id": "recs.fetch",
            "parent_span_id": "catalog.request",
            "operation_name": "Fetch Recommendations",
    ...
    logs.append(
        {
            "timestamp": (base_time + timedelta(milliseconds=60)).isoformat(),
            "level": "ERROR",
            "message": "ML model timeout",
            "trace_id": "trace-error-001",
            "span_id": "recs.model",
            "parent_span_id": "recs.fetch",
    ...
    logs.append(
        {
            "timestamp": (base_time + timedelta(milliseconds=4900)).isoformat(),
            "level": "ERROR",
