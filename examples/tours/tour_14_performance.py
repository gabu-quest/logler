...
def _():
    ...
    return Path, datetime, json, random, temp_dir, time, timedelta, timezone
...
def _(Path, datetime, json, random, temp_dir, time, timedelta, timezone):
    ...
    return NUM_ENTRIES, file_size, large_log
...
def _(
    ...
    print("\n" + "=" * 60)
    print("Use these numbers as a baseline; timings vary by machine.")
    print("=" * 60)
    return
